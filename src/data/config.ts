const config = {
  title: "Ankit Singh | SDE-1  Developer",
  description: {
    ...
    short:
      "Discover the portfolio of Abhijit, a SDE-1  Developer solving real life problems in DevOps and Development.",
  },
  keywords: [
    "Abhijit",
    "Ankit Singh",
  ...
  social: {
    ...
    linkedin: "https://www.linkedin.com/in/imankii01t/",
