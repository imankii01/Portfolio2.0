...
const projects: Project[] = [
  ...
  //   github: "https://github.com/Ankit-Khatri/Coding-Ducks",
  //   get content() {
  //     return (
  //       <div>
  ...
  //   screenshots: ["1.png"],
  //   live: "http://Ankitkhatri.vercel.app",
  //   github:"https://github.com/Ankit-Khatri/Portfolio",
  //   skills: {
  //     frontend: [
  //       PROJECT_SKILLS.ts,
  //       PROJECT_SKILLS.next,
  ...
  //   github:"https://github.com/Ankit-Khatri/GhostChat",
  //   skills: {
  ...
  //   screenshots: ["1.png"],
  //   live: "https://Ankit-khatri.github.io/JNTUA-result-analyser-spa/#/",
  //   skills: {
